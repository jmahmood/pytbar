...
class YuubinBango(object):
	...
	def load_array(self, arr):
		...
		self.manual_city_entry, \
		self.manual_street_entry, \
		self.multiple_locals, \
		self.recently_changed, self._recently_changed_reason = arr
	...
	def fields():
		...
		'has_multiple_local','manual_city_entry','manual_street_entry','multiple_locals',
		'recently_changed','_recently_changed_reason']
